...
<!--For creating real result tables with individual-valued cells, and organize the result view better, just use the EL with
each attribute of each Client object returned as result in the List<Client>. Organize the table display properties with css 
and html divs.-->
