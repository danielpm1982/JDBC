...
/*
As there no DDL has been used at the programming side, a pre-existing scheme, tables and values should be mannually set at the DB
(through Workbench suite, for example) before this test script is executed, as described at the img package. 
